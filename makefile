...
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/main.o ${BUILD_DIR}/Matrix.o ${BUILD_DIR}/Functions.o ${BUILD_DIR}/TerminalFunctions.o ${BUILD_DIR}/Commands.o ${BUILD_DIR}/MemoryFunctions.o
...
${BUILD_DIR}/Commands.o: ${SRC_DIR}/Commands.cpp ${INCLUDE_DIR}/Commands.hpp ${INCLUDE_DIR}/MemoryFunctions.hpp
