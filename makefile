...
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/main.o ${BUILD_DIR}/Matrix.o ${BUILD_DIR}/Functions.o ${BUILD_DIR}/TerminalFunctions.o ${BUILD_DIR}/Commands.o ${BUILD_DIR}/MemoryFunctions.o ${BUILD_DIR}/Decompositions.o
...
${BUILD_DIR}/Commands.o: ${SRC_DIR}/Commands.cpp ${INCLUDE_DIR}/Commands.hpp ${INCLUDE_DIR}/MemoryFunctions.hpp ${INCLUDE_DIR}/Decompositions.hpp 
...
${BUILD_DIR}/Decompositions.o: ${SRC_DIR}/Decompositions.cpp ${INCLUDE_DIR}/Decompositions.hpp ${INCLUDE_DIR}/Matrix.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Decompositions.cpp -o ${BUILD_DIR}/Decompositions.o
