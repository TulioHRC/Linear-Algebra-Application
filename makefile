...
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/main.o ${BUILD_DIR}/Matrix.o ${BUILD_DIR}/Functions.o ${BUILD_DIR}/TerminalFunctions.o
...
${BUILD_DIR}/main.o: ${SRC_DIR}/main.cpp ${INCLUDE_DIR}/Matrix.hpp ${INCLUDE_DIR}/Functions.hpp ${INCLUDE_DIR}/TerminalFunctions.hpp
